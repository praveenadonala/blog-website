...
export const typeTester = (value, type) => {
    let valid;
    switch (type) {
...
export const enumTester = (value, arr) => {
    return arr.includes(value);
};
export const lengthTester = (value, length) => {
    return value.length === length;
};
export const minLengthTester = (value, minLength) => {
    return value.length >= minLength;
};
export const maxLengthTester = (value, maxLength) => {
...
export const minNumberTester = (value, min) => {
    return value >= min;
};
export const exclusiveMinNumberTester = (value, min) => {
    return value > min;
};
export const maxNumberTester = (value, max) => {
    return value <= max;
};
export const exclusiveMaxNumberTester = (value, max) => {
    return value < max;
};
export const stringTester = (value) => {
    return typeof value === 'string';
};
export const stringRegExpTester = (value, regExp) => {
    let valid = false;
...
export const minDateTester = (value, min) => {
    return +value >= +min;
};
export const exclusiveMinDateTester = (value, min) => {
    return +value > +min;
};
export const maxDateTester = (value, max) => {
    return +value <= +max;
};
export const exclusiveMaxDateTester = (value, max) => {
    return +value < +max;
};
export const arrayTester = (value) => {
    return Array.isArray(value);
};
export const arrayTypeOfTester = (array, type) => {
